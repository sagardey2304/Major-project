...
class NavigationAgent(BaseAgent):
    ...
    def __init__(self, message_bus, config: Dict[str, Any] = None):
        ...
        print(f"[{self.name}] Navigation Agent initialized")  # FIX: Use self.name instead of self.agent_name
    ...
    def _process_detections(self, detections: List[Dict[str, Any]]):
        ...
        try:
            ...
            print(f"[{self.name}] Error processing detections: {e}")  # FIX: Use self.name
            
    def _run(self):
        """Main navigation loop"""
        print(f"[{self.name}] Starting navigation loop")  # FIX: Use self.name
        ...
        while self._running:
            try:
                ...
                print(f"[{self.name}] Error in navigation loop: {e}")  # FIX: Use self.name
                
        print(f"[{self.name}] Navigation loop stopped")  # FIX: Use self.name
    ...
    def handle_message(self, message: Message):
        ...
        try:
            ...
            elif message.type == MessageType.SYSTEM_STATUS:  # FIX: Use message.type
                data = message.data
